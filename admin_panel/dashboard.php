...
<div class="content">
    ...
    <main>
        ...
        <div class="welcome-banner" style="background: linear-gradient(135deg, #0052cc, #00b8d9); border-radius: 20px; padding: 30px; margin-bottom: 30px; color: white; display: flex; align-items: center; justify-content: space-between; box-shadow: 0 15px 30px rgba(0, 82, 204, 0.3); overflow: hidden; position: relative;">
            <div style="z-index: 2;">
                <h2 style="margin: 0; font-size: 32px; font-weight: 700;">Welcome back! 👋</h2>
                <p style="margin: 10px 0 0 0; font-size: 16px; opacity: 0.9;">Here's an overview of your school's performance right now.</p>
            </div>
            <div style="z-index: 2;">
        ...
        <div class="bottom-data" style="display: grid; grid-template-columns: 2fr 1fr; gap: 24px; margin-top: 24px;">
            <div class="saas-card">
                <div class="header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3 style="font-size: 18px; font-weight: 600; color: #0F172A;"><i class='fas fa-chart-line' style="color: #4F46E5; margin-right: 8px;"></i> Revenue & Enrollment Growth</h3>
                </div>
            ...
            <div class="saas-card">
                <div class="header" style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                    <h3 style="font-size: 18px; font-weight: 600; color: #0F172A;"><i class='fas fa-chart-pie' style="color: #F59E0B; margin-right: 8px;"></i> Attendance Overview</h3>
                </div>
