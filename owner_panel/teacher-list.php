...
<head>
    ...
    <title>Bitgenius - Owner Teacher List</title>
...
<body style="background-color: #F8FAFC; font-family: 'Inter', sans-serif;">
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex align-items-center">
        ...
        <div class="input-group" style="background: #F1F5F9; border-radius: 8px; border: 1px solid #E2E8F0; padding: 4px;">
            <input class="form-control border-0 bg-transparent shadow-none" type="search" placeholder="Search Teachers..." id="search-teacher" aria-label="Search">
    ...
    <div class="teacher-list container mt-5">
        <div class="card border-0" style="border-radius: 20px; box-shadow: 0 10px 15px -3px rgba(0,0,0,0.1); overflow: hidden;">
            <div class="card-header bg-white" style="padding: 24px; border-bottom: 1px solid #E2E8F0;">
                <h3 style="margin: 0; font-size: 20px; font-weight: 700; color: #0F172A;"><i class="fas fa-chalkboard-teacher" style="color: #4F46E5; margin-right: 10px;"></i> Teacher Directory</h3>
            </div>
          ...
          <thead style="background-color: #F8FAFC;">
            <tr>
              ...
              <th scope="col" style="padding: 16px 24px; color: #64748B; font-weight: 600; font-size: 13px; text-transform: uppercase;">Gender</th>
