<nav style="background: white; box-shadow: 0 4px 6px -1px rgba(0,0,0,0.05); padding: 10px 24px;">
  ...
  <div class="dropdown dropdown-center" style="margin-left: auto;">
                <a href="#" class="notif"  href="#"  data-bs-toggle="dropdown" aria-expanded="false" style="position: relative; color: #64748B; font-size: 20px; margin-right: 20px;">
                    ...
                    <span class="count" style="position: absolute; top: -5px; right: -8px; background: #EF4444; color: white; border-radius: 50%; width: 18px; height: 18px; font-size: 10px; display: flex; justify-content: center; align-items: center;">2</span>
                </a>
              
                <ul class="dropdown-menu">
                  <li><a class="dropdown-item">Schedule updated</a></li>
                  <li><a class="dropdown-item">New assignment submitted</a></li>
                </ul>
              </div>
